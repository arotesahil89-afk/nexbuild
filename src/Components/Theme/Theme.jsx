...
const Theme = () => {
  ...
  useGSAP(() => {
    ...
    tl.from(videoRef.current, {
      ...
      duration: 1.5,
      ease: "power4.out",
    }, "-=1"); // overlaps slightly for smooth entrance
  }, { scope: containerRef });

  return (
    <section
      ref={containerRef}
      className="px-4 py-16 bg-gradient-to-br from-red-100 to-white"
    >
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div
          ref={videoRef}
          className="relative w-full max-w-3xl mx-auto h-0 pb-[56.25%] rounded-xl shadow-lg overflow-hidden border border-red-200"
          style={{ willChange: "transform, opacity" }}
        >
          <iframe
