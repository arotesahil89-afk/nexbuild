...
const Padyapujan = () => {
  const { t } = useTranslation("padyapujan");
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div
          ref={videoRef}
          className="relative w-full max-w-3xl mx-auto h-0 pb-[56.25%] rounded-xl shadow-lg overflow-hidden border border-yellow-300"
          style={{ willChange: "transform, opacity" }}
        >
          <iframe
